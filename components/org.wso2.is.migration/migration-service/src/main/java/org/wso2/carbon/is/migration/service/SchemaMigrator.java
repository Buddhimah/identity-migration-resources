...
public class SchemaMigrator extends Migrator {
    ...
    private void executeSQL(String sql) throws Exception {
        ...
        try {
            ...
            if (e.getSQLState().equals("X0Y32") || e.getSQLState().equals("42710") || e.getSQLState().equals("42P07")) {
                // eliminating the table already exception for the derby,postgre and DB2 database types
                if (log.isDebugEnabled()) {
